...
def build_parser():
    ...
    parser.add_argument("--expected-controls-sha256", default=EXPECTED_CONTROLS_SHA256)
    return parser
...
def main(argv=None):
    ...
    if controls_hash != args.expected_controls_sha256:
        raise RuntimeError(
            "retained controls SHA-256 mismatch: "
            f"actual={controls_hash} expected={args.expected_controls_sha256}")
